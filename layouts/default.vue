            ...
            <div class="navbar">
                ...
                <div class="navbar-collapse" :class="{ showMenu }">
                    <ul>
                        <li
                            :class="{
                                'blog-active': $route.path === '/' || $route.path.startsWith('/blog')
                            }"
                            @click="hideMenu"
                        >
                            <nuxt-link to="/"> <font-awesome-icon :icon="['fas', 'pen-nib']" />博 </nuxt-link>
                            <div class="nav-line" />
                        </li>
                        <li :class="{ 'guestbook-active': $route.path === '/guestbook' }" @click="hideMenu">
                            <nuxt-link to="/guestbook"> <font-awesome-icon :icon="['fas', 'comment-dots']" />留言 </nuxt-link>
                            <div class="nav-line" />
                        </li>
                        <li :class="{ 'profile-active': $route.path === '/profile' }" @click="hideMenu">
                            <nuxt-link to="/profile"> <font-awesome-icon :icon="['fas', 'user']" />关于 </nuxt-link>
                            <div class="nav-line" />
                        </li>
                        <li class="dark-tools">
...
.navbar .navbar-brand {
    ...
    color: #2b2b2b;
    font-size: 18px;
    font-family: -apple-system, BlinkMacSystemFont, 'Arial', 'Segoe UI', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', 'Helvetica Neue', Helvetica,
