<template>
    <a-locale-provider :locale="zhCN">
        <a-layout class="layout-admin">
            <a-layout-sider v-model="collapsed" :trigger="null" breakpoint="lg" collapsible class="layout-sider">
                ...
                <a-layout-header class="layout-header">
                    ...
                    <div class="auth-actions">
                        <a-dropdown placement="bottomRight">
                            ...
                            <a-menu slot="overlay">
                                <a-menu-item>
                                    <a href="/auth/change-password"> <font-awesome-icon :icon="['fas', 'key']" style="margin-right: 5px;" />修改密码 </a>
                                </a-menu-item>
                                <a-menu-item>
