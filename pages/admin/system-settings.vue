        ...
        <div class="page-body">
            <a-form :form="form" :self-update="true">
                ...
                <a-form-item :colon="false">
                    ...
                    <a-textarea v-decorator="['blogIntro']" placeholder="请输入博客简介" :rows="2" :autosize="{ minRows: 2, maxRows: 6 }" />
                </a-form-item>
            ...
            <div class="btn-wrap">
                <a-button type="primary" @click="save"> <font-awesome-icon :icon="['far', 'save']" style="margin-right: 4px;" />保存设置 </a-button>
                <a-button @click="reset"> <font-awesome-icon :icon="['fas', 'undo']" style="margin-right: 4px;" />恢复默认 </a-button>
            </div>
        </div>
    </div>
</template>
