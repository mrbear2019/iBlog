        ...
        <div class="search-wrap">
            <div class="filter-wrap">
                <a-input-group compact>
                    <a-select v-model="filterType" size="large" class="filter-type" @change="filterTypeChange">
                    ...
                    <a-range-picker
                        ...
                        class="input-ele"
                    />
                    <a-button type="primary" size="large" class="search-btn" @click="search">
                        <font-awesome-icon :icon="['fas', 'search']" style="margin-right: 5px;" />搜索
                    </a-button>
                </a-input-group>
            </div>
        </div>
