        ...
        <div class="comments-panel">
            <div class="gituser-wrap">
                ...
                <div class="editor-wrap">
                    ...
                    <client-only>
                        <editor ref="editor" height="150px" preview-style="tab" :options="editorOptions" @load="onEditorLoad" />
                    </client-only>
            ...
            <div class="comment-list">
                <ul>
                    <li v-for="comment in comments" :key="comment._id" class="comment-li">
                        <comment-item :comment="comment" :avatar="getAvatar(comment.username)" @referenceReply="referenceReply" />
                    </li>
                </ul>
